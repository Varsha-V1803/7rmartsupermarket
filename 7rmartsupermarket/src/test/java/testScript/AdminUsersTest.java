...
public class AdminUsersTest extends Base {
	...
	@Test(groups = {
			"regression" }, description = "Verify whether the user is able to add a new information in the adminusers page sucessfully", retryAnalyzer = retry.Retry.class)
	public void verifyWhetherUserIsAbleToCreateNewAdminUser() throws IOException {
		...
		String user = faker.creatARandomFirstName();// used for fake username generation and is present inside the
													// fakerutility class
		String userpass = faker.creatARandomFirstName();// used for fake userpassword generation and is present inside
														// the fakerutility class
