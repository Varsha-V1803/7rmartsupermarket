...
public class HomePage {
	...
	@FindBy(xpath="//a[contains(@href,'tes.com/admin/list-admin')and @class='small-box-footer']")WebElement infoadmin;
	@FindBy(xpath="//a[contains(@href,'tes.com/admin/list-contact')]")WebElement infocontact;
	@FindBy(xpath="//a[contains(@href,'niqassosiates.com/admin/list-news')]")WebElement infonews;
	@FindBy(xpath="//a[contains(@href,'qassosiates.com/admin/list-footertext')]")WebElement infofooter;
	@FindBy(xpath="//a[contains(@href,'/admin/list-category')]")WebElement infocategory;
