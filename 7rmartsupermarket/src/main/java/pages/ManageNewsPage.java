...
//@FindBy(xpath="//a[contains(@href,'niqassosiates.com/admin/list-news')]")WebElement info;
	...
	/*
	 * public void moreInfoNewsPage() { info.click(); }
	 */
	...
	public ManageNewsPage save() {
		...
		/*
		 * PageUtility pageutility=new PageUtility(); pageutility.click(driver, save1);
		 */
		WaitUtility waitutility = new WaitUtility();
		waitutility.waitForElementToBeClickable(driver, save1);
		save1.click();
		return this;
	}
